...
const JobDetails = () => {
  return (
    <div className="w-full h-auto flex justify-center items-center bg-[#EEEEEE]">
      <div className="content flex flex-row my-4">
        {/* child-1 */}
        <div className="w-[120px] h-auto flex flex-col gap-3">
          {/* item-1 */}
          ...
          {/* item-2 */}
          <div className="w-full flex flex-col bg-[#424242] ">
            ...
            <div className="w-full p-1 flex gap-1  justify-center items-center bg-[#424242] text-[11px] font-[600] text-[#ecf0f1] cursor-pointer hover:bg-[#4C4C4C]">
              <span>Clear All</span>
              <img
